<footer class="footer">
                    ...
                    <div class="footer-block author">
                        <ul>
                            <li> created by | <a><!--a href="https://github.com/modularcode"-->elecomp</a> </li>
        ...
        <script src="<?=base_url()?>assets/js/app.js"></script>
         <script src="<?=base_url()?>assets/js/jquery-2.1.4.js" type="text/javascript"></script>
          <script src="<?=base_url()?>assets/js/dataTbSungai.js" type="text/javascript"></script>
    <!-- Bootstrap 3.3.2 JS -->
    <script src="<?=base_url()?>assets/js/bootstrap.min.js" type="text/javascript"></script>
 
       <script src="<?=base_url()?>assets/js/bootstrap-table.js" type="text/javascript"></script>
