<?php $this->load->view('front/header_rekapswd1') ?>
	...
	<div class="container" >
		<div class="panel panel-primary">
		  <div class="panel-heading">
		    <h3 class="panel-title">Pintu Banjir</h3>
		  </div>
		  <div class="panel-body">
		    	<div class="row">

			<?php $foto1= 'rekap pintu banjir swd 1.jpg';?>
	                	<a href="#" onclick="show_image('<?=base_url()?>assets/img/rekap/<?=$foto1;?>',0);" >
		                        <div class="col-xs-12" style="margin-top: 10px;">
		
		                        	<div style="box-shadow: 1px 1px 2px 0px rgba(0, 0, 0, 0.1);background-position: center center; background-size: cover;  height: 1300px; background-image: url('<?=base_url()?>assets/img/rekap/<?=$foto1?>');">&nbsp;</div>   
