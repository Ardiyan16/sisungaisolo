	...
	<div class="container" >
		<div class="panel panel-primary">
		  ...
		  <div class="panel-body">
			...
			<?php $foto1= 'rekap pintu banjir swd 2.jpg';?>
	                	<a href="#" onclick="show_image('<?=base_url()?>assets/img/rekap/<?=$foto1;?>',0);" >
		                        <div class="col-xs-12" style="margin-top: 10px;">
		
		                        	<div style="box-shadow: 1px 1px 2px 0px rgba(0, 0, 0, 0.1);background-position: center center; background-size: cover;  height: 2000px; background-image: url('<?=base_url()?>assets/img/rekap/<?=$foto1?>');">&nbsp;</div>   
