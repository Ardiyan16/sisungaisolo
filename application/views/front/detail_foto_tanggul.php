<?php $this->load->view('front/header_patok') ?>
		...
		<div class="row">
		  ...
		  <div class="panel-body">
		    	...
		    	<div class="row">
						...
						<?php
						for($x=0; $x < $totimg; $x++){
						// 	echo "<li><img src='".base_url($imgdir . $a_img[$x])."'" . $imgdir . $a_img[$x] . "' /></li>"; echo $imgdir . $a_img[$x];
						//
						//
						// echo "</ul>";

						?>
						<a href="#" onclick="show_image('<?php echo base_url($imgdir . $a_img[$x])  ?>',0);" >
							<div class="col-md-6" style="margin-top: 10px;">
								<div style="box-shadow: 1px 1px 2px 0px rgba(0, 0, 0, 0.1);background-position: center center; background-size: cover;  height: 225px;  background-image: url('<?php echo base_url($imgdir . $a_img[$x])  ?>');">&nbsp;</div>
							</div>
						</a>
	...
	<div id="myModal" class="modal">
	  ...
	  <div id="caption"></div>
		...
		myImage[<?php echo $x; ?>]="<?php echo base_url($imgdir . $a_img[$x])  ?>";
