	...
	<div class="container" >
		<div class="panel panel-primary">
		  <div class="panel-heading">
		    <h3 class="panel-title">Foto Saluran</h3>
		  </div>
		  <div class="panel-body">
		    	<div class="row">
                    ...
                    <?php
                        $i=0;
                        foreach($saluran AS $key){ ?>
                            
                        <a href="#" onclick="show_image('<?=base_url()?>images/sungai/<?=$key->gambar?>',<?=$i?>);" >
                            <div class="col-xs-12 col-md-3" style="margin-top: 10px;">

                                <div style="box-shadow: 1px 1px 2px 0px rgba(0, 0, 0, 0.1);background-position: center center; background-size: cover;  height: 225px;  background-image: url('<?=base_url()?>images/sungai/<?=$key->gambar?>');">&nbsp;</div>                                                                                                      
                            </div>                               
                        </a>
                    <?php    
                            $i++;
	...
	<div id="myModal" class="modal">
	  ...
	  <div id="caption"></div>
        ...
        var myImage= new Array(); 
            ...
            <?php  $nn=0; foreach($saluran AS $key){
                ?>
                myImage[<?=$nn?>]="<?=base_url()?>images/sungai/<?=$key->gambar?>";       
            <?php 
                    $nn++;
