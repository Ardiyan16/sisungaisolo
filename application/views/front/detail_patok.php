<?php $this->load->view('front/header_patok') ?>
	...
	<div class="container">
		...
		<div class="row" >
			<div class="col-md-12" id="clo" >
				<img class="img-responsive" src="<?php echo base_url() ?>data/detail/patok/data1/<?php echo str_replace(" ", "", $patok->file1); ?>" >
			...
			<div class="col-md-12" id="clo" >
				<img class="img-responsive" src="<?php echo base_url() ?>data/detail/patok/data2/<?php echo str_replace(" ", "", $patok->file1); ?>" >
