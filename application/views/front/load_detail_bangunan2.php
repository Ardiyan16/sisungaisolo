                      ...
                      <table class="table table-hover">
                                <tbody>
                                    ...
                                    <tr style="background-color: #FFF;color: #000;">
                                        ...
                                        <td>:</td>
                                        <td id="tahun_data_bendung"><?php echo $data_bangunan->penyedia_jasa_konstruksi?></td>
                                    </tr>
                                     <tr style="background-color: #FFF;color: #000;">
                                        <td scope="row">Tahun Selesai</td>
                                        <td>:</td>
                                        <td id="bendung_kode_das"><?php echo $data_bangunan->masa_konstruksi?></td>
                                    </tr>
                                    <tr style="background-color: #FFF;color: #000;">
                                        <td scope="row">Item Pekerjaan</td>
                                        <td>:</td>
                                        <td id="nama_bendung"><?php echo $data_bangunan->item_pekerjaan ?></td>
                                    </tr>
                                    ...
                                    <tr style="background-color: #FFF;color: #000;">
                                        ...
                                        <td>:</td>
                                        <td id="tahun_data_bendung"><?php echo $data_bangunan->volume ?></td>
                                    </tr>
                                     <tr style="background-color: #FFF;color: #000;">
                                        <td scope="row">Satuan</td>
                                        <td>:</td>
                                        <td id="tahun_data_bendung"><?php echo $data_bangunan->satuan ?></td>
                                    </tr>
                                    <tr style="background-color: #FFF;color: #000;">
                                    ...
                                    <tr style="background-color: #FFF;color: #000;">
                                        ...
                                        <td>:</td>
                                        <td id="tahun_data_bendung"><?php echo $data_bangunan->keterangan ?></td>
                                    </tr>
                                    
                                    <tr style="background-color: #FFF;color: #000;">
                                        <td scope="row">Penilaian Kinerja</td>
                                        <td>:</td>
                                        <td id="tahun_data_bendung"><?php echo $data_bangunan->penilaian_kinerja ?></td>
                                    </tr>
                                    <tr style="background-color: #FFF;color: #000;">
                                        <td scope="row">AKNOP</td>
                                        <td>:</td>
                                        <td id="tahun_data_bendung"><?php echo $data_bangunan->aknop ?></td>
                                    </tr >
                                     <tr style="background-color: #FFF;color: #000;">
                                        <td scope="row">Tahun Data</td>
                                        <td>:</td>
                                        <td id="desa_bendung"><?php echo $data_bangunan->tahun_data;?></td>
                                    </tr>
                                </tbody>
                  </table>
                    </div>
