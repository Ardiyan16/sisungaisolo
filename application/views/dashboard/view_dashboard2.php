...
<ul class="sidebar-panel nav">
  ...
  <li><a href="<?php echo base_url('peta/dashboard') ?>"><span class="icon color5"><i class="fa fa-tree"></i></span>Peta</a></li>
  ...
  <li><a href="<?php echo base_url('peta/rekap_data') ?>"><span class="icon color6"><i class="fa fa-th"></i></span>Tanggul</a></li>
