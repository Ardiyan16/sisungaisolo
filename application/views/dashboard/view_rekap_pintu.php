...
<div class="content">
  ...
  <div class="page-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Rekap Pintu</li>
    </ol>

    <!-- Start Page Header Right Div -->
    <div class="right">
      <div class="btn-group" role="group" aria-label="...">
        <a href="index-2.html" class="btn btn-light">Rekap Pintu</a>
      ...
      <div class="col-md-12">
        <div class="panel panel-default">
          ...
          <div class="panel-body table-responsive">
            <p><a href="#" onclick="printPintu()" class="btn btn-success"><i class="fa fa-print"></i>Export ke Excel</a></p>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Detail Kinerja Pintu</h4>
        </div>
...
<script>
  ...
  $(document).ready(function() {
    ...
    table = $('#examplene').DataTable({
      ...
      "ajax": {
        ...
        "url": "<?php echo site_url('rekap_data/ajax_list_pintu') ?>",
  ...
  function detail_kinerja_pintu(id) {
    $('#myModal').modal('show');
    ...
    table2 = $('#examplene2').DataTable({
      ...
      "ajax": {
        ...
        "url": "<?php echo site_url('rekap_data/ajax_list_pintu_id') ?>/" + id,
  ...
  function printPintu() {
    ...
    let goto = `${ling}rekap_data/getSheetPintu?pintu=pintu&uniq=${uniq}`;
