  ...
  <div class="page-header">
    <h1 class="title">Rekap</h1>
      <ol class="breadcrumb">
        ...
        <li class="active">Rekap Infrastruktur Eksternal</li>
      </ol>

    <!-- Start Page Header Right Div -->
    <div class="right">
      <div class="btn-group" role="group" aria-label="...">
        <a href="index-2.html" class="btn btn-light">Rekap Infrastruktur Eksternal</a>
    ...
    <div class="col-md-12">
      <div class="panel panel-default">
        <div class="panel-title">
          Rekap Infrastruktur Eksternal
        </div>
        <div class="panel-body table-responsive">
        <p><a href="<?php echo base_url('peta/export_excel_eksternal') ?>" class="btn btn-success"><i class="fa fa-print"></i>Export ke Excel</a></p>
  ...
  $(document).ready(function() {
    ...
    table = $('#examplene').DataTable({ 
        ...
        "ajax": {
            ...
            "url": "<?php echo site_url('rekap_data/ajax_list_eksternal')?>",
