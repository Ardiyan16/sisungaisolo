...
<style type="text/css">
  td.details-control {
    background: url('https://cdn.rawgit.com/DataTables/DataTables/6c7ada53ebc228ea9bc28b1b216e793b1825d188/examples/resources/details_open.png') no-repeat center center cursor: pointer
  }
...
<div class="content">
  ...
  <div class="page-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Rekap Tebing</li>
    </ol>

    <!-- Start Page Header Right Div -->
    <div class="right">
      <div class="btn-group" role="group" aria-label="...">
        <a href="index-2.html" class="btn btn-light">Rekap Tebing</a>
      ...
      <div class="col-md-12">
        <div class="panel panel-default">
          ...
          <div class="panel-body table-responsive">
            <p><a href="#" onclick="printTebing()" class="btn btn-success"><i class="fa fa-print"></i>Export ke Excel</a></p>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Detail Inspeksi Tebing</h4>
        </div>
  ...
  $(document).ready(function() {
    ...
    table = $('#exam').dataTable({
      ...
      "ajax": {
        ...
        "url": "<?php echo site_url('rekap_data/ajax_list_tebing') ?>",
  ...
  function detail_paket(id) {
    ...
    table2 = $('#examplene2').DataTable({
      ...
      "ajax": {
        ...
        "url": "<?php echo site_url('rekap_data/ajax_list_tebing_id') ?>/" + id,
