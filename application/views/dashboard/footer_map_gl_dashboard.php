...
<script type="text/javascript">
 var link_peta = "<?php echo site_url('peta_dashboard')?>";
 var link = "<?php echo site_url('peta')?>";
 
 "use strict";
$(document).ready(function (e) {
   google.maps.event.addDomListener(window, 'load', mapInit);
  // $("#modelCekdamDetail").modal("hide"),$("#modelMataairDetail").modal("hide"),$("#modelTerbangunDetail").modal("hide"),$("#modelPintuDetail").modal("hide"),$("#modelRevertmenDetail").modal("hide"),$("#modelTebingDetail").modal("hide"),$("#modelTanggulDetail").modal("hide")
...
function drawUsulanInternal(e, a, t, n, r){
    e.setMap(n);
    var r = "<?php echo base_url('peta_dashboard/api_usulan_internal')?>";
    $.ajax({
        method: "GET",
        url: r,
        cache: !1,
    ...
    }), addUsulanInternalFunc(e, n), e.setStyle(function (e) {
        return {
        icon: {
            url: "https://cdn.mapmarker.io/api/v1/pin?size=120&background=%237B64FF&text=I&color=%23FFFFFF&voffset=2&hoffset=1&",
            size: new google.maps.Size(24, 24),
            scaledSize: new google.maps.Size(24, 24)
        }
        }
...
function drawUsulanEksternal(e, a, t, n, r){
    e.setMap(n);
    var r = "<?php echo base_url('peta_dashboard/api_usulan_eksternal')?>";
    $.ajax({
        method: "GET",
        url: r,
        cache: !1,
    ...
    }), addUsulanEksternalFunc(e, n), e.setStyle(function (e) {
        return {
        icon: {
            url: "https://cdn.mapmarker.io/api/v1/pin?size=120&background=%23FA28FF&text=E&color=%23FFFFFF&voffset=2&hoffset=1&",
            size: new google.maps.Size(24, 24),
            scaledSize: new google.maps.Size(24, 24)
        }
        }
...
function mapInit() {
  function e() {
    ...
    }else if ("usulan_internal" == a) {
        if (resetLayerSearch(), "undefined" == typeof layerSearch.usulan_internal) {
        var l = new google.maps.Data;
        drawUsulanInternal(l, e, null, map), layerSearch.usulan_internal = l, tapToPoint(l, map)
      } else drawUsulanInternal(layerSearch.usulan_internal, e, null, map), tapToPoint(layerSearch.usulan_internal, map);
    }else if ("usulan_eksternal" == a) {
        if (resetLayerSearch(), "undefined" == typeof layerSearch.usulan_eksternal) {
        var l = new google.maps.Data;
        drawUsulanEksternal(l, e, null, map), layerSearch.usulan_eksternal = l, tapToPoint(l, map)
      } else drawUsulanEksternal(layerSearch.usulan_eksternal, e, null, map), tapToPoint(layerSearch.usulan_eksternal, map);
    }
  ...
  }), $("#daftar-layer-content #usulan_internal").change(function (e) {
    if (resetLayerSearch(), e.preventDefault(), $(this).prop("checked")) {
			var a = new google.maps.Data;
			("undefined" == typeof layer.usulan_internal || null == layer.usulan_internal) && (drawUsulanInternal(a, null, null, map), layer.usulan_internal = a)
		} else "undefined" != typeof layer.usulan_internal && (null != layer.usulan_internal && (layer.usulan_internal.setMap(null), layer.usulan_internal.revertStyle()), layer.usulan_internal = null)
  }), $("#daftar-layer-content #usulan_eksternal").change(function (e) {
    if (resetLayerSearch(), e.preventDefault(), $(this).prop("checked")) {
			var a = new google.maps.Data;
			("undefined" == typeof layer.usulan_eksternal || null == layer.usulan_eksternal) && (drawUsulanEksternal(a, null, null, map), layer.usulan_eksternal = a)
		} else "undefined" != typeof layer.usulan_eksternal && (null != layer.usulan_eksternal && (layer.usulan_eksternal.setMap(null), layer.usulan_eksternal.revertStyle()), layer.usulan_eksternal = null)
...
function addMataAirFunc(e, a) {
  ...
  }), $(document).on("click", ".btn-mataair-detail-ongoing", function (e) {
      console.log('e',e);
  //  e.preventDefault();
    //  var n = e.feature.getProperty("id"),
    //  r = e.feature.getGeometry().get();
...
function addInfrastrukturTerbangunFunc(e, a) {
  e.addListener("mouseover", function (e) {
    ...
    null != infowindow && infowindow.close(), infowindow = new google.maps.InfoWindow({
      content: "<div class='pull-left'><img style='width:182px;height:122px;' class='img map-icon' src='<?php echo base_url('data/img/bangunan')?>/"+gambar+"' style='margin-top:10px;'></div><div class='pull-right' style='margin-left: 12px;'><h4 style='font-size: 12px;'><strong>" + e.feature.getProperty("nama") + "</strong></h4><hr><div class='text-center'><a class='btn-mataair-detail-terbangun' data-pk='" + n + "' role='button'>Klik untuk detail....</a></div></div>"
    }), infowindow.setPosition(r), infowindow.setOptions({
      pixelOffset: new google.maps.Size(0, -20)
    }), infowindow.open(a)
  }), e.addListener("mouseout", function (a) {
  ...
  }), $(document).on("click", ".btn-mataair-detail-terbangun", function (e) {
    e.preventDefault();
    var a = $(this).data("pk");
...
function addPintuFunc(e, a){
  ...
  }), $(document).on("click", ".btn-mataair-detail-pintu", function (e) {
    e.preventDefault();
    var a = $(this).data("pk");
...
function addRevertmenFunc(e, a){
  e.addListener("mouseover", function (e) {
    ...
    null != infowindow && infowindow.close(), infowindow = new google.maps.InfoWindow({
      content: "<div class='pull-left'><img style='width:182px;height:122px;' class='img map-icon' src='<?php echo base_url('data/img/bangunan/sungai-81_file1-.png')?>' style='margin-top:10px;'></div><div class='pull-right' style='margin-left: 12px;'><h4 style='font-size: 12px;'><strong>" + e.feature.getProperty("nama") + "</strong></h4><hr><div class='text-center'><a class='btn-mataair-detail-revertment' data-pk='" + n + "' role='button'>Klik untuk detail....</a></div></div>"
    }), infowindow.setPosition(r), infowindow.setOptions({
      pixelOffset: new google.maps.Size(0, -20)
    }), infowindow.open(a)
  }), e.addListener("mouseout", function (a) {
  ...
  }), $(document).on("click", ".btn-mataair-detail-revertment", function (e) {
    e.preventDefault();
    var a = $(this).data("pk");
...
function addTebingFunc(e, a){
    ...
    null != infowindow && infowindow.close(), infowindow = new google.maps.InfoWindow({
      content: "<div class='pull-left'><img style='width:182px;height:122px;' class='img map-icon' src='<?php echo base_url('data/img/bangunan/sungai-81_file1-.png')?>' style='margin-top:10px;'></div><div class='pull-right' style='margin-left: 12px;'><h4 style='font-size: 12px;'><strong>" + e.feature.getProperty("nama") + "</strong></h4><hr><div class='text-center'><a class='btn-mataair-detail-tebing' data-pk='" + n + "' role='button'>Klik untuk detail....</a></div></div>"
    }), infowindow.setPosition(r), infowindow.setOptions({
      pixelOffset: new google.maps.Size(0, -20)
    }), infowindow.open(a)
  }), e.addListener("mouseout", function (a) {
  ...
  }), $(document).on("click", ".btn-mataair-detail-tebing", function (e) {
    e.preventDefault();
    var a = $(this).data("pk");
...
function addCekdamFunc(e, a){
    ...
    null != infowindow && infowindow.close(), infowindow = new google.maps.InfoWindow({
      content: "<div class='pull-left'><img style='width:182px;height:122px;' class='img map-icon' src='<?php echo base_url('data/img/bangunan/sungai-81_file1-.png')?>' style='margin-top:10px;'></div><div class='pull-right' style='margin-left: 12px;'><h4 style='font-size: 12px;'><strong>" + e.feature.getProperty("nama") + "</strong></h4><hr><div class='text-center'><a class='btn-mataair-detail-cekdam' data-pk='" + n + "' role='button'>Klik untuk detail....</a></div></div>"
    }), infowindow.setPosition(r), infowindow.setOptions({
      pixelOffset: new google.maps.Size(0, -20)
    }), infowindow.open(a)
  }), e.addListener("mouseout", function (a) {
  ...
  }), $(document).on("click", ".btn-mataair-detail-cekdam", function (e) {
    e.preventDefault();
    var a = $(this).data("pk");
...
function addUsulanInternalFunc(e, a){
    e.addListener("mouseover", function (n) {
        null != infowindow && infowindow.close(), infowindow = new google.maps.InfoWindow({
        content: "<div class='pull-left'><img style='width:182px;height:122px;' class='img map-icon' src='<?php echo base_url('data/img/bangunan/sungai-81_file1-.png')?>' style='margin-top:10px;'></div><div class='pull-right' style='margin-left: 12px;'><h5 style='font-size: 12px;'><strong>" + n.feature.getProperty("nama") + "</strong></h5><hr><div class='text-center'><a class='btn-usulan-internal-detail' data-pk='" + n.feature.getProperty("id") + "' role='button'>Klik untuk detail....</a></div></div>"
        }), infowindow.setPosition(n.latLng), infowindow.open(a), e.overrideStyle(n.feature, {
        strokeWeight: 4,
        strokeOpacity: .8
        })
        ...
        var a = e.feature.getProperty("id");
        initMapsUsulanInternal(a);
    }), $(document).on("click", ".btn-usulan-internal-detail", function (e) {
        e.preventDefault();
        var a = $(this).data("pk");
        initMapsUsulanInternal(a);
    })
...
function addUsulanEksternalFunc(e, a){
  e.addListener("mouseover", function (n) {
        null != infowindow && infowindow.close(), infowindow = new google.maps.InfoWindow({
        content: "<div class='pull-left'><img style='width:182px;height:122px;' class='img map-icon' src='<?php echo base_url('data/img/bangunan/sungai-81_file1-.png')?>' style='margin-top:10px;'></div><div class='pull-right' style='margin-left: 12px;'><h5 style='font-size: 12px;'><strong>" + n.feature.getProperty("nama") + "</strong></h5><hr><div class='text-center'><a class='btn-usulan-eksternal-detail' data-pk='" + n.feature.getProperty("id") + "' role='button'>Klik untuk detail....</a></div></div>"
        }), infowindow.setPosition(n.latLng), infowindow.open(a), e.overrideStyle(n.feature, {
        strokeWeight: 4,
        strokeOpacity: .8
        })
        ...
        var a = e.feature.getProperty("id");
        initMapsUsulanEksternal(a);
    }), $(document).on("click", ".btn-usulan-eksternal-detail", function (e) {
        e.preventDefault();
        var a = $(this).data("pk");
        initMapsUsulanEksternal(a);
    })
...
function initMapsMataair(e) {
     $("#modelMataairDetail").modal("show");    
      $.ajax({
          type : 'post',
          url : link+"/create_load_ongoing2/"+e,
...
function initMapsTerbangun(e) {
 ...
 $.ajax({
     type : 'post',
     url : link+"/create_load_bangunan2/"+e,
...
function initMapsPintu(e) {
      ...
      $.ajax({
          type : 'post',
          url : link_peta+"/create_load_pintu/"+e,
          data :  'fv_idpintu='+ e,
          success : function(data){
            //console.log(data);
...
function initMapsRevertmen(e){
    $("#modelRevertmenDetail").modal("show");
      $.ajax({
          type : 'post',
          url : link_peta+"/create_load_revertmen/"+e,
...
function initMapsCekdam(e){
	...
	$.ajax({
          type : 'post',
          url : link_peta+"/create_load_cekdam/"+e,
          data :  'id_cekdam='+ e,
          success : function(data){
            //console.log(data);
...
function initMapsTanggul(e){
	...
	// $.ajax({
  //       url:"<?php echo base_url("peta/get_tanggul") ?>/"+e,
  //       type: "GET",
  //       dataType: "JSON",
  //       success: function(result){
  //         $('#sta').html(result.fv_STA);
  //         $('#kode_titik_awal').html(result.fv_kodetitikawal);
  //         $('#kode_titik_akhir').html(result.fv_kodetitikakhir);
  //         $('#panjang').html(result.fv_panjang);
  //         $('#panjang_kerusakan').html(result.fv_panjangkerusakan);
  //         $('#desa').html(result.fv_desa);
  //         $('#kecamatan').html(result.fv_kecamatan);
  //         $('#kabupaten').html(result.fv_kabupaten);
  //         $('#provinsi').html(result.fv_propinsi);
  //         $('#latitude').html(result.latitude);
  //         $('#longitude').html(result.longitude);
  //         $('#hasil_pengamatan').html(result.fv_hslpengamatan);
  //       }, 
...
function initMapsUsulanInternal(e){
     //menggunakan fungsi ajax untuk pengambilan data
     $("#modelUsulanInternal").modal("show");
     $.ajax({
          type : 'post',
          url : link+"/create_load_internal/"+e,
          data :  'id_usulan='+ e,
          success : function(data){
            //console.log(data);
...
function initMapsUsulanEksternal(e){
     //menggunakan fungsi ajax untuk pengambilan data
     $("#modelUsulanEksternal").modal("show");
     $.ajax({
          type : 'post',
          url : link+"/create_load_eksternal/"+e,
          data :  'id_usulan='+ e,
          success : function(data){
            //console.log(data);
...
}),$("#modelDasDetail").on("hidden.bs.modal", function (e) {
  e.preventDefault();
  for (var a = $("#daftar-layer-das-content").find('input[type="checkbox"]'), t = 0; t < a.length; t++) $(a[t]).prop("checked", !1), $(a[t]).trigger("checked");
//   removeChildComp('video-das');
//   removeChildComp('foto-das');
}), $("#modelBendungDetail").on("hidden.bs.modal", function (e) {
//  removeChildComp ('video-bendung');
//   removeChildComp('foto-bendung');
