...
<div class="content">
  ...
  <div class="page-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Rekap Revertmen</li>
    </ol>

    <!-- Start Page Header Right Div -->
    <div class="right">
      <div class="btn-group" role="group" aria-label="...">
        <a href="index-2.html" class="btn btn-light">Rekap Revertmen</a>
      ...
      <div class="col-md-12">
        <div class="panel panel-default">
          ...
          <div class="panel-body table-responsive">
            <p><a href="#" onclick="printRevertmen()" class="btn btn-success"><i class="fa fa-print"></i>Export ke Excel</a></p>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Detail Kinerja Revertmen</h4>
        </div>
...
<script>
  ...
  $(document).ready(function() {
    ...
    table = $('#examplene').DataTable({
      ...
      "ajax": {
        ...
        "url": "<?php echo site_url('rekap_data/ajax_list_rever') ?>",
  ...
  function detail_kinerja_revertmen(id) {
    $('#myModal').modal('show');
    ...
    table2 = $('#examplene2').DataTable({
      ...
      "ajax": {
        ...
        "url": "<?php echo site_url('rekap_data/ajax_list_revertmen_id') ?>/" + id,
  ...
  function printRevertmen() {
    let uniq = Math.random().toString(36).substring(2, 15) + Math.random().toString(36).substring(2, 15);
    let goto = `${ling}rekap_data/getSheetRevertmen?revertmen=revertmen&uniq=${uniq}`;
