...
class Bangunan_ extends CI_Controller {
    ...
    function foto($id_bangunan=null){
    	...
    	$this->load->view('front/foto_bangunan',$data);
    }
    
    function rekap_swd1($id_bangunan=null){
    	$bangunan = new M_bangunan();
    	$bangunan->where('id_bangunan',$id_bangunan);
        $data['menu_aktif']='foto';
        $data['id_bangunan']=$id_bangunan;
    	$data['bangunan']=$bangunan->get();
    	$this->load->view('front/foto_rekap',$data);
    }
    
    function pintu_swd1($id_bangunan=null){
    	$bangunan = new M_bangunan();
    	$bangunan->where('id_bangunan',$id_bangunan);
        $data['menu_aktif']='foto';
        $data['id_bangunan']=$id_bangunan;
    	$data['bangunan']=$bangunan->get();
    	$this->load->view('front/foto_rekappintuswd1.php',$data);
    }
    
    function tanggul_swd1($id_bangunan=null){
    	$bangunan = new M_bangunan();
    	$bangunan->where('id_bangunan',$id_bangunan);
        $data['menu_aktif']='foto';
        $data['id_bangunan']=$id_bangunan;
    	$data['bangunan']=$bangunan->get();
    	$this->load->view('front/foto_rekaptanggukswd1.php',$data);
    }
    
    function rekap_swd2($id_bangunan=null){
    	$bangunan = new M_bangunan();
    	$bangunan->where('id_bangunan',$id_bangunan);
        $data['menu_aktif']='foto';
        $data['id_bangunan']=$id_bangunan;
    	$data['bangunan']=$bangunan->get();
    	$this->load->view('front/foto_rekap2',$data);
    }
    
    function pintu_swd2($id_bangunan=null){
    	$bangunan = new M_bangunan();
    	$bangunan->where('id_bangunan',$id_bangunan);
        $data['menu_aktif']='foto';
        $data['id_bangunan']=$id_bangunan;
    	$data['bangunan']=$bangunan->get();
    	$this->load->view('front/foto_rekappintuswd2.php',$data);
    }
    
    function tanggul_swd2($id_bangunan=null){
    	$bangunan = new M_bangunan();
    	$bangunan->where('id_bangunan',$id_bangunan);
        $data['menu_aktif']='foto';
        $data['id_bangunan']=$id_bangunan;
    	$data['bangunan']=$bangunan->get();
    	$this->load->view('front/foto_rekaptanggukswd2.php',$data);
    }
    ...
    function detail($id_bangunan=null){
       ...
       // $excel= new Spreadsheet_Excel_Reader("data/excel/bangunan/".$data['bangunan']->file_excel);
